...
print('Humedad: ', + hum)
print('Temperatura: ', + abs(temp))
display.text('Temp:'+str(abs(temp)), 0, 10, 1)		#顯示'MicroPython Numebr1' 於位置*=(0,0) 
display.text('Humid:'+str(abs(hum)), 0, 20, 1)		#顯示'MicroPython Numebr1' 於位置*=(0,0) 
display.show()	#更新螢幕資料並顯示內容於OLED