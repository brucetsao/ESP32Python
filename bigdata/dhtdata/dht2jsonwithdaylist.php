<?php     
//http://localhost:8888/bigdata/dhtdata/dht2jsonwithdaylist.php?MAC=246F28248CE0&start=20200406&end=20200407
 ...
 $qry1 = "select MAC,left(systime,10) as systime FROM big.dhtData where MAC = '%s' and systime >= '%s' and systime <= '%s' group by left(systime,8)  order by systime asc;" ;		//將dhtdata的資料找出來
