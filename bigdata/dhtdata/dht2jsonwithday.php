<?php     
//http://localhost:8888/bigdata/dhtdata/dht2jsonwithday.php?MAC=246F28248CE0&start=20200406&end=20200407
...
while($row = mysqli_fetch_array($result))   //進入讀取資料的迴圈
	{
		...
		$subdata->Temperature = (double)sprintf("%6.2f",(double)$row["temperature"]);	
		$subdata->Humidity = (double)sprintf("%6.2f",(double)$row["humidity"] );
