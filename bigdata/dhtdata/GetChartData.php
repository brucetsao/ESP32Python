<?php
 //http://localhost:8888/bigdata/dhtdata/GetChartData.php?MAC=246F28248CE0&dt1=20200406&dt2=20200407
	...
	$qry ="select * from big.dhtData where MAC = '%s' and systime >= '%s' and systime <= '%s' order by systime desc " ;		//將dhtdata的資料找出來
